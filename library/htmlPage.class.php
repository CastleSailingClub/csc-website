 ...
 */
  ...
  class htmlPage
  {
    ...
    /**
     * Holds the name of the club's contact 
     */
    public $contact = "Marian Coffin";
    /**
     * Holds the email of the club's contact 
     */
    public $email = "castlesailingclub@gmail.com";
    /**
     * Holds the phone number of the club's contact 
     */
    public $phone = "02380 734 444";
...
echo("</pre>");*/
      ...
      if(parse_ini_file("contact-info.ini",true))
      {
        $iniFile = (object) parse_ini_file("contact-info.ini",true);
        $this->contact = $iniFile->contact;
        $this->email = $iniFile->email;
        $this->phone = $iniFile->phone;
      }
      return;
    }
